              ...
              <div class="col-lg-12">
                ...
                <table class="table text-center">
                  ...
                  <!-- <td><?php //echo $patient->id ?></td> -->
                    ...
                    <td><?php echo $todaysAppointment->patient_first_name . " " . $todaysAppointment->patient_last_name ?></td>
                    <td><?php echo $todaysAppointment->description ?></td>
                    <td><?php echo $todaysAppointment->dentist_first_name . " " . $todaysAppointment->dentist_last_name ?></td>
                    <td><?php echo $todaysAppointment->must_be_rescheduled==1 ? "<font color='red'>Yes</font>" : "<font color='green'>No</font>" ?></td>
                  </tr>
                  <?php
                  }
                  ?>
